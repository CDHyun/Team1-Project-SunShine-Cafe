...
public class StudyProductMain extends JFrame {
	...
	/* StudyProductOptionMain과 데이터를 주고 받을 getter & setter */
	public int getTotal() {
		return total;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StudyProductMain frame = new StudyProductMain();
	...
	private JLabel getLblItemSlot1() {
		if (lblItemSlot1 == null) {
			...
			lblItemSlot1.setBounds(66, 106, 120, 200);
	...
	private JLabel getLblItemSlot2() {
		if (lblItemSlot2 == null) {
			...
			lblItemSlot2.setBounds(247, 106, 120, 200);
		}
		return lblItemSlot2;
	}
	private JLabel getLblItemSlot3() {
		if (lblItemSlot3 == null) {
			...
			lblItemSlot3.setBounds(434, 106, 120, 200);
		}
		return lblItemSlot3;
	}
	private JLabel getLblItemSlot4() {
		if (lblItemSlot4 == null) {
			...
			lblItemSlot4.setBounds(66, 318, 120, 200);
		}
		return lblItemSlot4;
	}
	private JLabel getLblItemSlot5() {
		if (lblItemSlot5 == null) {
			...
			lblItemSlot5.setBounds(247, 318, 120, 200);
		}
		return lblItemSlot5;
	}
	private JLabel getLblItemSlot6() {
		if (lblItemSlot6 == null) {
			...
			lblItemSlot6.setBounds(432, 318, 120, 200);
	...
	private JLabel getLblProductName1() {
		if (lblProductName1 == null) {
			...
			lblProductName1.setBounds(72, 263, 114, 16);
		}
	...
	private JLabel getLblProductPrice1() {
		if (lblProductPrice1 == null) {
			...
			lblProductPrice1.setBounds(66, 283, 114, 16);
		}
	...
	private JLabel getLblProductName2() {
		if (lblProductName2 == null) {
			...
			lblProductName2.setBounds(253, 261, 114, 16);
		}
	...
	private JLabel getLblProductPrice2() {
		if (lblProductPrice2 == null) {
			...
			lblProductPrice2.setBounds(253, 283, 114, 16);
		}
	...
	private JLabel getLblProductName3() {
		if (lblProductName3 == null) {
			...
			lblProductName3.setBounds(440, 263, 114, 16);
		}
	...
	private JLabel getLblProductPrice3() {
		if (lblProductPrice3 == null) {
			...
			lblProductPrice3.setBounds(440, 283, 114, 16);
		}
	...
	private JLabel getLblProductName4() {
		if (lblProductName4 == null) {
			...
			lblProductName4.setBounds(66, 474, 114, 16);
		}
	...
	private JLabel getLblProductPrice4() {
		if (lblProductPrice4 == null) {
			...
			lblProductPrice4.setBounds(72, 489, 114, 16);
		}
	...
	private JLabel getLblProductName5() {
		if (lblProductName5 == null) {
			...
			lblProductName5.setBounds(253, 474, 114, 16);
		}
	...
	private JLabel getLblProductPrice5() {
		if (lblProductPrice5 == null) {
			...
			lblProductPrice5.setBounds(253, 496, 114, 16);
		}
	...
	private JLabel getLblProductName6() {
		if (lblProductName6 == null) {
			...
			lblProductName6.setBounds(434, 474, 114, 16);
		}
	...
	private JLabel getLblProductPrice6() {
		if (lblProductPrice6 == null) {
			...
			lblProductPrice6.setBounds(434, 496, 114, 16);
		}
	...
	private JLabel getLblProductImage1() {
		if (lblProductImage1 == null) {
			...
			lblProductImage1.setBounds(66, 127, 120, 124);
		}
	...
	private JLabel getLblProductImage2() {
		if (lblProductImage2 == null) {
			...
			lblProductImage2.setBounds(247, 127, 120, 124);
		}
	...
	private JLabel getLblProductImage3() {
		if (lblProductImage3 == null) {
			...
			lblProductImage3.setBounds(432, 127, 120, 124);
		}
	...
	private JLabel getLblProductImage4() {
		if (lblProductImage4 == null) {
			...
			lblProductImage4.setBounds(66, 338, 120, 124);
		}
	...
	private JLabel getLblProductImage5() {
		if (lblProductImage5 == null) {
			...
			lblProductImage5.setBounds(247, 338, 120, 124);
		}
	...
	private JLabel getLblProductImage6() {
		if (lblProductImage6 == null) {
			...
			lblProductImage6.setBounds(432, 338, 120, 124);
		}
	...
	private JLabel getLblJuice() {
		if (lblJuice == null) {
			...
			lblJuice.setBounds(320, 47, 94, 47);
		}
		return lblJuice;
	}
	...
	private JLabel getLblDessert() {
		if (lblDessert == null) {
			...
			lblDessert.setBounds(488, 47, 71, 47);
		}
		return lblDessert;
	}
		...
		if (lblTime == null) {
			...
			lblTime.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					lblBackGround5.setVisible(false);
					lblBackGround6.setVisible(false);
					lblBackGround7.setVisible(true);
					conditionItemQueryAction(6);
				}
			});
			lblTime.setHorizontalAlignment(SwingConstants.CENTER);
			lblTime.setFont(new Font("Noto Sans KR Medium", Font.BOLD, 14));
			lblTime.setBounds(557, 47, 71, 47);
		}
		return lblTime;
	}
	...
	private JLabel getLblBackGround1() {
		if (lblBackGround1 == null) {
			...
			lblBackGround1.setBounds(32, 47, 83, 47);
		}
	...
	private JLabel getLblBackGround2() {
		if (lblBackGround2 == null) {
			...
			lblBackGround2.setBounds(127, 47, 83, 47);
			lblBackGround2.setVisible(false);
		}
	...
	private JLabel getLblBackGround3() {
		if (lblBackGround3 == null) {
			...
			lblBackGround3.setBounds(230, 47, 78, 47);
		}
	...
	private JLabel getLblBackGround4() {
		if (lblBackGround4 == null) {
			...
			lblBackGround4.setBounds(323, 47, 91, 47);
		}
	...
	private JLabel getLblBackGround5() {
		if (lblBackGround5 == null) {
			...
			lblBackGround5.setBounds(417, 47, 70, 47);
		}
	...
	private JLabel getLblBackGround6() {
		if (lblBackGround6 == null) {
			...
			lblBackGround6.setBounds(489, 47, 70, 47);
		}
		return lblBackGround6;
	}
	
	private JLabel getLblBackGround7() {
		if (lblBackGround7 == null) {
			lblBackGround7 = new JLabel("");
			ImageIcon icon = new ImageIcon(ProductMain.class.getResource("/com/javalec/image/backGround.png"));
			int x = 60;
			int y = 60;
			ImageResize resize = new ImageResize(icon, x, y);
			ImageIcon backGround = resize.imageResizing();
			lblBackGround7.setIcon(backGround);
			lblBackGround7.setHorizontalAlignment(SwingConstants.CENTER);
			lblBackGround7.setForeground(Color.WHITE);
			lblBackGround7.setFont(new Font("Noto Sans KR Medium", Font.BOLD, 14));
			lblBackGround7.setBounds(558, 47, 70, 47);
		}
		return lblBackGround7;
	}
