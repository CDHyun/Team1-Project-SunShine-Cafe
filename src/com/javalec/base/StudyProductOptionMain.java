...
public class StudyProductOptionMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StudyProductOptionMain frame = new StudyProductOptionMain();
	...
	private JLabel getLblTitle() {
		if (lblTitle == null) {
			...
			lblTitle.setBounds(248, 6, 394, 47);
		}
		return lblTitle;
	}
	private JLabel getLblTitle_1() {
		if (lblTitle_1 == null) {
			...
			lblTitle_1.setBounds(248, 50, 394, 35);
		}
		return lblTitle_1;
	}
	private JLabel getLblBack() {
		if (lblBack == null) {
			...
			lblBack.setBounds(0, 84, 900, 229);
		}
		return lblBack;
	}
	private JLabel getLblProductImage() {
		if (lblProductImage == null) {
			...
			lblProductImage.setBounds(-2, 84, 150, 215);
		}
	...
	private JLabel getLblShot() {
		if (lblShot == null) {
			...
			lblShot.setBounds(16, 352, 116, 154);
		}
		return lblShot;
	}
	private JLabel getLblSyrup() {
		if (lblSyrup == null) {
			...
			lblSyrup.setBounds(166, 352, 116, 154);
		}
		return lblSyrup;
	}
	private JLabel getLblSugar() {
		if (lblSugar == null) {
			...
			lblSugar.setBounds(313, 351, 116, 154);
		}
		return lblSugar;
	}
	private JLabel getLblOption() {
		if (lblOption == null) {
			...
			lblOption.setBounds(452, 340, 448, 172);
		}
		return lblOption;
	}
	private JLabel getLblCartBtn() {
		if (lblCartBtn == null) {
			...
			lblCartBtn.setBounds(473, 616, 189, 82);
		}
		return lblCartBtn;
	}
	private JLabel getLblCancle() {
		if (lblCancle == null) {
			...
			lblCancle.setBounds(212, 616, 189, 82);
		}
		return lblCancle;
	}
	...
	private JLabel getLblAddShot() {
		if (lblAddShot == null) {
			...
			lblAddShot.setBounds(479, 387, 68, 24);
		}
		return lblAddShot;
	}
	private JLabel getLblAddSyrup() {
		if (lblAddSyrup == null) {
			...
			lblAddSyrup.setBounds(479, 423, 68, 24);
		}
		return lblAddSyrup;
	}
	private JLabel getLblAddSugar() {
		if (lblAddSugar == null) {
			...
			lblAddSugar.setBounds(479, 459, 68, 24);
		}
		return lblAddSugar;
	}
	private JLabel getLblAddShot2() {
		if (lblAddShot2 == null) {
			...
			lblAddShot2.setBounds(559, 387, 30, 24);
		}
		return lblAddShot2;
	}
	private JLabel getLblAddSyrup2() {
		if (lblAddSyrup2 == null) {
			...
			lblAddSyrup2.setBounds(559, 423, 30, 24);
		}
		return lblAddSyrup2;
	}
	private JLabel getLblAddSugar2() {
		if (lblAddSugar2 == null) {
			...
			lblAddSugar2.setBounds(559, 459, 30, 24);
		}
		return lblAddSugar2;
	}
	private JLabel getLblAddSugar3() {
		if (lblAddSugar3 == null) {
			...
			lblAddSugar3.setBounds(580, 459, 30, 24);
		}
		return lblAddSugar3;
	}
	private JLabel getLblAddSyrup3() {
		if (lblAddSyrup3 == null) {
			...
			lblAddSyrup3.setBounds(580, 423, 30, 24);
		}
		return lblAddSyrup3;
	}
	private JLabel getLblAddShot3() {
		if (lblAddShot3 == null) {
			...
			lblAddShot3.setBounds(580, 387, 30, 24);
		}
		return lblAddShot3;
	}
	private JLabel getLblResetBtn() {
		if (lblResetBtn == null) {
			...
			lblResetBtn.setBounds(776, 350, 117, 47);
		}
		return lblResetBtn;
	}
